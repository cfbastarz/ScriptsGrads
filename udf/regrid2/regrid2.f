      program regrid
      parameter(nimax=3000,njmax=1500,n1max=nimax*2,
     $     niopt=4,nvopt=8)
      ...
      dimension fld_in(nimax,njmax),area_in(nimax,njmax),
     $     fld_out(nimax,njmax),dum1(nimax,njmax),
     $     area_out(nimax,njmax)
